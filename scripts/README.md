...
| 5 | Config Snetor — règles d'équipe importées dans le CLAUDE.md global, output styles, hooks (`guard.py` en `PreToolUse`, `worktree_memory.py` en `SessionStart`), settings.json (plugins), status line |
